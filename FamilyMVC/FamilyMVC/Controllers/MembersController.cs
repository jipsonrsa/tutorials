...
namespace FamilyMVC.Controllers
{
    public class MembersController : Controller
    {
        ...
        public async Task<ActionResult> Create([Bind(Include = "Id,LastName,FirstMidName")] Members members)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<ActionResult> Edit([Bind(Include = "Id,LastName,FirstMidName")] Members members)
        {
            if (ModelState.IsValid)
            {
